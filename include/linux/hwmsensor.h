...
#define SENSOR_TTYPE_STEP_DETECTOR     18
#define SENSOR_TTYPE_RELATIVE_HUMIDITY 12
#define  SENSOR_TTYPE_STEP_COUNTER     19
...
#define ID_RELATIVE_HUMIDITY                 (ID_BASE+SENSOR_TTYPE_RELATIVE_HUMIDITY-1)
#define ID_STEP_DETECTOR                        (ID_BASE+SENSOR_TTYPE_STEP_DETECTOR-1)
#define ID_STEP_COUNTER                         (ID_BASE+SENSOR_TTYPE_STEP_COUNTER-1)

#define ID_SENSOR_MAX_HANDLE			(ID_BASE+19)
#define ID_NONE							(ID_BASE+25)
...
#define EVENT_SENSOR_RELATIVE_HUMIDITY SENSOR_RELATIVE_HUMIDITY
#define EVENT_SENSOR_STEP_DETECTOR     SENSOR_STEP_DETECTOR
#define EVENT_SENSOR_STEP_COUNTER     SENSOR_STEP_COUNTER
/*-----------------------------------------------------------------------------*/
